...
<section>
  ...
  <div class="container my-5">
    <div class="row d-flex align-items-center">
      <div class="col-md-12">
        <p class="lead text-justify">El presente Política de Privacidad establece los términos en que <strong>Techno-RA.</strong> usa y protege la información que es proporcionada
        ...
        <p class="lead text-justify">Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para mantener un registro de usuarios,
          ...
          <strong>Techno-RA.</strong> está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más
          avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
        </p>
        ...
        <p class="lead text-justify">La devolución de productos sólo será aceptada dentro de los diez (10) días de recibida la mercadería. El cambio de los productos por daño
          ...
          entrega. Los cambios y/o devoluciones deberán realizarse por el Centro de Ayuda del Sitio (www.Techno-RA.com) y/o al teléfono 0810 5555 3728 que se
        ...
        <p class="lead text-justify">En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada a nuestro sitio web. 
          ...
          <strong>Techno-RA.</strong> reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
        </p>
      </div>
    </div>
  </div>
